...
Color OPrimaryColor = const Color(0xffF05C35);
Color OSecondaryColor = const Color(0xffF5E06E);
Color OThirdColor = const Color(0xff51DB51);

Color OSuccess = const Color(0xff289D3D);
Color OGoodGreen = const Color(0xff27AE60);
...
Color OTextPrimaryColor = const Color(0xff202B36);
Color OTextsecondaryColor = const Color(0xff19204E);
